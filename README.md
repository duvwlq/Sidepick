...
- `deploy-auth-backend`
  - 백엔드 인증, OAuth, 경험 등록 관련 작업을 모아 둔 브랜치
- `ai` 또는 `feature/ai-*`
  - AI 모델, 데이터, 분석 로직, AI 관련 문서 작업을 분리해서 진행하는 브랜치
- `develop`
  - 공용 개발 브랜치
- `feature/fe-setup`
  - 프론트 초기 세팅 관련 작업 브랜치
...
AI 작업도 `main`에서 직접 하지 말고 별도 AI 브랜치에서 진행한 뒤 통합 브랜치로 병합합니다.

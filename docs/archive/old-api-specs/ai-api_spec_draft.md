...
> 🚫 **이 문서는 T5 모델 폐기 전(2026-04-28 이전) 작성된 초안입니다.**
> 🚫 **현재 구현과 일치하지 않습니다.** (URL, 필드, 응답 형식 모두 다름)
>
> ✅ **최신 명세서: [`API.md`](./API.md)를 참고해주세요.**
>
> _히스토리 보존 목적으로만 남겨둡니다._

---

# FailForward AI-BE API 규격서 (초안 — 폐기됨)

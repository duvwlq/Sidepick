...
- `BE-01` 문서 작성 완료, 팀장 확인 반영 완료
- `BE-02` 문서 작성 완료, 팀장 확인 반영 완료
- `BE-04` 문서 작성 완료, `.env.example` 반영 완료, 팀장 확인 반영 완료
- `BE-07` 문서 작성 완료, 팀장 확인 반영 완료
...
- 메모:
  ...
  - 팀장 확인 결과 네이버 2주차 포함, `/api/auth/providers` 포함, pseudo email 유지로 확정
...
1. P0 문서 팀장 확인 받기
2. `BE-03`, `BE-05`, `BE-06` 구현 선행 이슈 정리
3. 필요 시 P1 문서도 팀장 코멘트 반영 후 `완료` 처리

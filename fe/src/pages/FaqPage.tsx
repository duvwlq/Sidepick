...
const FAQ_TAGS = ['전체', '계정', '경험 등록', '분석', '탐색', 'MY', '신고', '기타'];
...
const FAQ_ITEMS = [
  {
    ...
    answer:
      '하단 등록 탭에서 단계별 정보를 입력한 뒤 작성 완료를 누르면 경험 등록과 분석 요청이 함께 진행됩니다.',
  },
  {
    id: 2,
            ...
            return (
              <article key={item.id} className="flex w-full flex-col items-start">
                <button
                  ...
                  className="flex h-[60px] w-full items-center justify-between bg-[#FFFFFF] p-[20px]"
                >

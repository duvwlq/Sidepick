...
function StoryPreviewCard({
  ...
  const showThumbnail = Boolean(imageUrls[0]);
      ...
      <article className={`flex w-full flex-col gap-[8px] bg-white px-[16px] py-[20px] ${cardHeightClass}`}>
        <div className="flex flex-col gap-[8px]">
          ...
          <div className="flex h-[60px] items-start gap-[8px]">
            ...
            <div className={`flex h-[60px] min-w-0 flex-col ${showThumbnail ? 'w-[223px] shrink-0' : 'w-full flex-1'} gap-[4px]`}>
              <p className="line-clamp-1 font-['Pretendard'] text-[14px] font-[600] leading-[16.8px] text-[#131416]">
                {sanitizeText(experience.title, '제목')}
              </p>
              <p className={`${showThumbnail ? 'line-clamp-1' : 'line-clamp-2'} font-['Pretendard'] text-[12px] font-[400] leading-[16.8px] text-[#494949]`}>
                {preview}
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-[16px]">
          <div className="flex flex-col gap-[8px]">
            <div className="min-w-0 flex-1">
              <p className="font-['Pretendard'] text-[14px] font-[500] leading-[16.8px] text-[#131416]">제목을 입력해 주세요</p>
              <p className="line-clamp-1 font-['Pretendard'] text-[12px] font-[400] leading-[16.8px] text-[#494949]">
                아직 임시 저장된 글은 없어요. 새로운 경험을 작성해 보세요.
              </p>
            </div>
          </div>
          <div className="flex items-center gap-[4px] font-['Pretendard'] text-[12px] leading-[16.8px]">
            <span className="font-[400] text-[#5A876E]">임시 저장</span>
            <span className="font-[300] text-[#8A8A8A]">•</span>
            <span className="font-[300] text-[#8A8A8A]">작성 시작 전</span>
          </div>
        </div>
      </button>
    </section>
  ...
  return (
    <section className="w-full rounded-[4px] bg-white p-[12px] shadow-[0_0_2px_rgba(0,0,0,0.1)]">
      ...
      <div className="mt-[10px] flex flex-col gap-[10px]">
        {items.length ? (
          items.slice(0, 2).map((experience) => <StoryPreviewCard key={experience.id} experience={experience} />)
        ) : (
      ...
      <main className="isolate flex flex-col items-start px-[16px] pb-[110px]">
        <div className="flex w-full flex-col gap-[20px]">
          ...
          <StorySection
            ...
            emptyMessage={loading ? '불러오는 중...' : '작성한 글이 아직 없어요'}
          ...
          <StorySection
            ...
            emptyMessage={loading ? '불러오는 중...' : '최근 본 글이 아직 없어요'}
